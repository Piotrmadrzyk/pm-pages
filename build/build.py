...
PAGES = [
    ...
    dict(file='realizacje.html', active='realizacje.html',
         title='Realizacje — pięć stron, które naprawdę działają | Probatum',
         desc='Pięć w pełni działających, wielostronicowych witryn osadzonych na żywo. Nie obrazki, tylko prawdziwe strony, które możesz otworzyć i sprawdzić.'),
