...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var FAQ = [
    ...
    { keys: ['strona','strony','www','witryna'], a: 'Buduję wielostronicowe witryny dopasowane do konkretnej branży — nie szablony z katalogu. Zobacz 4 pełne realizacje w zakładce Realizacje, każda to gotowa, żywa strona.', link: {label:'Zobacz realizacje →', href:'realizacje.html'} },
    ...
    { keys: ['dona','agent','agenci','ai','jak dziala'], a: 'Dona to rdzeń systemu — steruje zespołem wyspecjalizowanych agentów AI (budowa stron, kampanie, social media). Każda ich praca przechodzi przeze mnie ręcznie, zanim trafi do sieci.', link: {label:'Poznaj Donę →', href:'o-donie.html'} },
