...
(() => {
  ...
  const prompts = {
    mail: ['„Napisz odpowiedź na e-mail.”', 'Przygotuj uprzejmy szkic odpowiedzi na zapytanie o usługę.', 'Wkleję wiadomość klienta i informacje o ofercie. Używaj tylko tych danych. Wskaż, czego brakuje.', 'Zwróć szkic do 120 słów oraz pytania do wyjaśnienia. Nie wymyślaj ceny ani terminu. Niczego nie wysyłaj.'],
    social: ['„Napisz coś na social media.”', 'Zaproponuj pięć tematów publikacji odpowiadających na pytania moich klientów.', 'Podam opis firmy, ofertę, odbiorców i pytania z ostatnich rozmów. Oprzyj pomysły na tych informacjach. Nie dopisuj osiągnięć ani opinii klientów.', 'Dla każdego pomysłu podaj temat, główną myśl, propozycję formatu i następny krok dla czytelnika. Zaznacz informacje wymagające sprawdzenia. Niczego nie publikuj.'],
    research: ['„Zrób research mojej branży.”', 'Pomóż zaplanować research rynku przed uruchomieniem nowej marki.', 'Podam pomysł, rynek geograficzny, grupę odbiorców i wstępne założenia. Oddziel informacje przekazane przeze mnie od hipotez do sprawdzenia.', 'Zwróć listę pytań badawczych, proponowane źródła i sposób weryfikacji. Nie wymyślaj danych rynkowych ani wyników badań. Wskaż, czego jeszcze potrzebujesz.']
  };
